Shader "Custom/Rounded Cube Grid" 
{
	...
	SubShader 
	{
		...
		#pragma surface surf Standard fullforwardshadows vertex:vert // Physically based Standard lighting model, and enable shadows on all light types
		...
		{
			fixed4 c = tex2D (_MainTex, IN.cubeUV) * _Color; // Albedo comes from a texture tinted by color
			o.Albedo = c.rgb;
